package org.wildfly.a2a.jakarta.jsonrpc.multiversion;
...
@Provider
@PreMatching
public class MultiVersionA2ARequestFilter implements ContainerRequestFilter {
    private static final Logger LOGGER = LoggerFactory.getLogger(MultiVersionA2ARequestFilter.class);
    ...
    private static boolean isNonStreamingRequest(String requestBody) {
        ...
        return requestBody.contains(GET_TASK_METHOD) ||
                ...
                // v0.3 non-streaming methods
                requestBody.contains(SendMessageRequest_v0_3.METHOD) ||
