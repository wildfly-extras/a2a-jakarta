...
import org.wildfly.a2a.jakarta.test.common.producer.SecurityAwareMultiVersionAgentCardProducer;
...
public class MultiVersionRestWithTaskAuthorizationTest extends AbstractA2AServerWithTaskAuthorizationTest {
    ...
    protected String getTransportUrl() {
        return "http://localhost:" + System.getProperty("test.agent.card.port", DEFAULT_TEST_PORT);
    }
    ...
    public static WebArchive createTestArchive() throws Exception {
        ...
        WebArchive archive = ShrinkWrap.create(WebArchive.class, "ROOT.war")
                ...
                .addClass(SecurityAwareMultiVersionAgentCardProducer.class);
        // Remove upstream AgentCardProducer so our SecurityAwareMultiVersionAgentCardProducer
        // (which includes security schemes) is used instead
